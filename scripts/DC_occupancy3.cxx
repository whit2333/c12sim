...
int DC_occupancy3(
   ...
   c0->SaveAs(Form("data/results/DC_occupancy/DC_occupancy3_layeravg_%d.png",aNumber));
   c0->SaveAs(Form("data/results/DC_occupancy/DC_occupancy3_layeravg_%d.pdf",aNumber));
   ...
   for(int sl = 1; sl<=6; sl++) {
      ...
      hs3->SetMaximum(2.0);
      mathtex.DrawMathText(0.4,0.83,"\\mathscr{L} = 1.3 \\times 10^{35} [cm^{-2}s^{-1}]");
      c0->SaveAs(Form("data/results/DC_occupancy/DC_occupancy3_slavg_%d_%d.png",sl,aNumber));
      c0->SaveAs(Form("data/results/DC_occupancy/DC_occupancy3_slavg_%d_%d.pdf",sl,aNumber));
   }
   //}
   ...
   for(int sec = 1; sec<=6; sec++) {
      ...
      mathtex.DrawMathText(0.4,0.83,"\\mathscr{L} = 1.3 \\times 10^{35} [cm^{-2}s^{-1}]");
      c0->SaveAs(Form("data/results/DC_occupancy/DC_occupancy3_sec%d_%d.pdf",sec,aNumber));
   }
   ...
   hs0->SetMaximum(4.0);
   mathtex.DrawMathText(0.4,0.83,"\\mathscr{L} = 1.3 \\times 10^{35} [cm^{-2}s^{-1}]");
   c0->SaveAs(Form("data/results/DC_occupancy/DC_occupancy3_allsec_%d.png",aNumber));
   c0->SaveAs(Form("data/results/DC_occupancy/DC_occupancy3_allsec_%d.pdf",aNumber));
   ...
   mathtex.DrawMathText(0.4,0.83,"\\mathscr{L} = 1.3 \\times 10^{35} [cm^{-2}s^{-1}]");
   c0->Update();
   c0->SaveAs(Form("data/results/DC_occupancy/DC_occupancy3_allsec_yfixed_%d.png",aNumber));
   c0->SaveAs(Form("data/results/DC_occupancy/DC_occupancy3_allsec_yfixed_%d.pdf",aNumber));
   ...
   mathtex.DrawMathText(0.4,0.83,"\\mathscr{L} = 1.3 \\times 10^{35} [cm^{-2}s^{-1}]");
   c0->Update();
   c0->SaveAs(Form("data/results/DC_occupancy/DC_occupancy3_allsec_yfixed1_%d.png",aNumber));
   c0->SaveAs(Form("data/results/DC_occupancy/DC_occupancy3_allsec_yfixed1_%d.pdf",aNumber));
   ...
   c->SaveAs(Form("data/results/DC_occupancy/DC_occupancy3_%d.png",aNumber));
   c->SaveAs(Form("data/results/DC_occupancy/DC_occupancy3_%d.pdf",aNumber));

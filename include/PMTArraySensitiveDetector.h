#ifndef PMTArraySensitiveDetector_HH
#define PMTArraySensitiveDetector_HH 1
 ...
 * \ingroup Detectors
 */
class PMTArraySensitiveDetector : public G4VSensitiveDetector {
   ...
   public:
      ...
      PMTArraySensitiveDetector( G4String name, G4int Nchan = 12);
      virtual ~PMTArraySensitiveDetector();

#ifndef RecoilHodoDetectorGeometry2_HH
#define RecoilHodoDetectorGeometry2_HH
...
class RecoilHodoDetectorGeometry2 {
   ...
   private:
      ...
      ScintTileDetectorGeometry   *  fScintTileDetectorGeometry = nullptr;

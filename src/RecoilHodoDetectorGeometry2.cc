...
RecoilHodoDetectorGeometry2::RecoilHodoDetectorGeometry2()
{
   ...
   fScintTileDetectorGeometry = new ScintTileDetectorGeometry();
...
RecoilHodoDetectorGeometry2::~RecoilHodoDetectorGeometry2()
{
   ...
   if(fScintTileDetectorGeometry) delete fScintTileDetectorGeometry;

}
//______________________________________________________________________________

void RecoilHodoDetectorGeometry2::BuildMaterials()
{
   using std::vector;
   int     natoms           = 0;
   int     ncomponents      = 0;
   ...
   if(fScintTileDetectorGeometry) fScintTileDetectorGeometry->BuildMaterials();
...
void RecoilHodoDetectorGeometry2::BuildLogicalVolumes()
{
   using namespace CLHEP;
   ...
   if(fScintTileDetectorGeometry){
      fScintTileDetectorGeometry->fRadius = (8.0 + 1.3)*CLHEP::cm;
      fScintTileDetectorGeometry->BuildLogicalVolumes();
   }
...
G4VPhysicalVolume * RecoilHodoDetectorGeometry2::PlacePhysicalVolume(
      ...
      G4VPhysicalVolume * adjacent_phys  )
{
   ...
   fScintTileDetectorGeometry->PlacePhysicalVolume(mother,mother_phys);
